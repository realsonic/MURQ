...
# Лексемы
_Примечения:_  
1. Не отображаемые символы табуляции `\t` и новой строки `\n` показаны экранированными спецсимволами.
2. Лексемы для инструкций пока не учитывают переносы строк `_` и объединение инструкций `&`.
