...
| `style_dos_textcolor` | `style_dos_textcolor = 202`   | Устанавливает цвет текста и фона локаций. Значение – восьмибитное целое число, младшие 4 бита которого отвечают за цвет, а старшие 4 – за фон.
